...
const Page3 = () => {
  return (
    <div className='min-h-screen flex items-start justify-center gap-20  w-full  p-16 '>
 <div className=' mt-20 flex flex-col gap-6 ml-2 mb-32'>
...
Best Business Project
    ...
    <div className='mt-20 flex flex-col gap-6 mr-2 mb-32'>
   <div className='h-20 w-[25vw] flex items-center justify-center bg-cover bg-[url(https://cdn.prod.website-files.com/65ef0d86eff3b9ba6b18aef9/65f86f4ba6e239d1ffadbfc4_Vector%204.svg)] '>
Best Business Project
    </div>
    <div className='h-20 w-[25vw] flex items-center justify-center bg-cover bg-[url(https://cdn.prod.website-files.com/65ef0d86eff3b9ba6b18aef9/65f86f4ba6e239d1ffadbfc4_Vector%204.svg)] '>
